...
def expected_working_hours(start_date, end_date, PENSUM):
    # -----------------------------------
    # Sollzeit berechnen
    ...
    # Feiertage für alle betroffenen Jahre berechnen
    holidays = set()
    for year in range(start.year, end.year + 1):
        holidays.update(solothurn_holidays(year))
